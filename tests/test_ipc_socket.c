...
static void test_ipc_socket_init_server(void **state) {
    ...
    will_return(mock_socket, ((ipc_socket_t *)sock)->sockfd);

    expect_value(mock_bind, sockfd, ((ipc_socket_t *)sock)->sockfd);
    ...
    expect_value(mock_listen, sockfd, ((ipc_socket_t *)sock)->sockfd);
...
static void test_ipc_socket_init_client(void **state) {
    ...
    expect_value(mock_connect, sockfd, ((ipc_socket_t *)sock)->sockfd);
...
static void test_ipc_socket_send(void **state) {
    ...
    expect_value(mock_send, sockfd, ((ipc_socket_t *)sock)->sockfd);
...
static void test_ipc_socket_receive(void **state) {
    ...
    expect_value(mock_recv, sockfd, ((ipc_socket_t *)sock)->sockfd);
    expect_value(mock_recv, buf, buffer);
...
static void test_ipc_socket_destroy(void **state) {
    ...
    expect_value(mock_close, fd, ((ipc_socket_t *)sock)->sockfd);
...
static void test_ipc_socket_accept(void **state) {
    ...
    expect_value(mock_accept, sockfd, ((ipc_socket_t *)server_sock)->sockfd);
    expect_any(mock_accept, addr);  // Match any address
    expect_any(mock_accept, addrlen); // Match any address length
    will_return(mock_accept, 1);  // Simulate successful accept
